...
### Insights:
- Job categories with higher average salaries often have fewer vacancies.
- Categories with significant demand include **Data Science**, **Cloud Engineering**, and **DevOps**.

### Visualization:
![Average Salary by Job Category](average_salary_by_category_plot.png)
...
### Insights:
- **Kyiv**, **Lviv**, and **Kharkiv** offer the highest salaries and largest number of IT vacancies.
- Smaller cities show significantly fewer opportunities but maintain competitive salaries.

### Visualization:
![Average Salary by City](top_cities_plot.png)
...
### Insights:
- **Remote jobs** often have slightly higher average salaries than office-based roles.
- A significant number of vacancies are now remote-friendly, reflecting global IT trends.

### Visualization:
![Remote vs Office Work](remote_vs_office_plot.png)
...
### Insights:
- A large portion of job postings across categories do not display salary information.
- **Job Categories like Data Science and AI** tend to reveal salaries more often.

### Visualization:
![Salary Visibility by Job Category](salary_visibility_plot.png)
...
### Insights:
- Salaries for IT jobs cluster between **20,000 UAH and 60,000 UAH**, with some outliers exceeding 200,000 UAH.

### Visualization:
![Salary Distribution](salary_distribution_plot.png)
